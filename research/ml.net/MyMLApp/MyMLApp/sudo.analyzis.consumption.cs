...
namespace MyMLApp
{
    ...
    {
        /// <summary>
        /// model input class for Sudo_analyzis.
        /// </summary>
        ...
        /// <summary>
        /// model output class for Sudo_analyzis.
        /// </summary>
        ...
        private static string MLNetModelPath = Path.GetFullPath("sudo.analyzis.mlnet");
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("qualification");
            if (labelColumn == null)
            {
                throw new Exception("qualification column not found. Make sure the name searched for matches the name in the schema.");
            }

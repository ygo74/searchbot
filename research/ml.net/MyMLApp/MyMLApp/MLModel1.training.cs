...
namespace MyMLApp
{
    ...
    {
        public const string RetrainFilePath =  @"C:\devel\searchbot\research\ml.net\MyMLApp\MyMLApp\yelp_labelled.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col0",outputColumnName:@"col0")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LbfgsMaximumEntropy(new LbfgsMaximumEntropyMulticlassTrainer.Options(){L1Regularization=0.04163447F,L2Regularization=0.6678067F,LabelColumnName=@"col1",FeatureColumnName=@"Features"}))      

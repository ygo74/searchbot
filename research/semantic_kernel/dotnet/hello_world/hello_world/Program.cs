...
// https://github.com/microsoft/semantic-kernel-starters/blob/main/sk-csharp-hello-world/Program.cs
...
using StreamReader reader = new(Assembly.GetEntryAssembly().GetManifestResourceStream("hello_world.prompts.Chat.yaml")!);
